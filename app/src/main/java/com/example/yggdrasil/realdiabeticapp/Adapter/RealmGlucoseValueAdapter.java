...
public abstract class RealmGlucoseValueAdapter<T extends RealmModel, S extends RecyclerView.ViewHolder>
     ...
     *
     * @see #RealmGlucoseValueAdapter(OrderedRealmCollection, boolean, boolean)
     */
    public RealmGlucoseValueAdapter(@Nullable OrderedRealmCollection<T> data, boolean autoUpdate) {
